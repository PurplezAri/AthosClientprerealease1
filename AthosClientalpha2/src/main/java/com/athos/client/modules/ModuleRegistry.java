...
public class ModuleRegistry {
    ...
    private static void addHud(String id, String name, boolean defaultEnabled) {
        ...
        // Extra options for Potion HUD
        if ("potions".equals(id)) {
            m.add(new BoolSetting("showTier", "Show Potion Tier (I/II/III)", true));
            m.add(new BoolSetting("mmss", "Timer Format mm:ss", true));
        }
    }
